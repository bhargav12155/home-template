...
export async function analyzePropertyStyle(imageUrl: string): Promise<ArchitecturalStyle> {
  try {
...
export async function batchAnalyzeStyles(properties: Array<{id: string, imageUrl: string}>): Promise<Map<string, ArchitecturalStyle>> {
